...
const Chatbot: React.FC = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const prompt = "You are a ai doctor give consultation and basic medicine telling for their health like paracetamol, dolo for headache, aspirin for fever and painkillers for body pain and many more that you know. Only tell about that medicine that is asked. and question that is not related to health or medical then refuge it";
